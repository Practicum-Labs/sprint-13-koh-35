package ru.yandex.practicum.sprint13koh35
...
import ru.yandex.practicum.sprint13koh35.databinding.VCatalogItemBinding
...
class CatalogItemViewHolder(
    ...
    fun bind(viewData: CatalogItemViewData) {
        ...
        binding.price.text = binding.root.resources.getString(R.string.patern, viewData.item.price / 100, viewData.item.unit)
